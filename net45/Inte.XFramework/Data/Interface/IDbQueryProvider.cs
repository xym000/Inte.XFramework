...
namespace Inte.XFramework.Data
{
    ...
    public interface IDbQueryProvider
    {
        ...
        /// <param name="sqlList">SQL 命令</param>
        /// <param name="transaction">事务</param>
        Task<List<int>> ExecuteAsync(List<string> sqlList, IDbTransaction transaction = null);
        ...
        /// <param name="query2">SQL 命令</param>
        /// <param name="transaction">事务</param>
        Task<Tuple<List<T1>, List<T2>>> ExecuteMultipleAsync<T1, T2>(IDbQueryable<T1> query1, IDbQueryable<T2> query2, IDbTransaction transaction = null);
        ...
        /// <param name="query3">SQL 命令</param>
        /// <param name="transaction">事务</param>
        Task<Tuple<List<T1>, List<T2>, List<T3>>> ExecuteMultipleAsync<T1, T2, T3>(IDbQueryable<T1> query1, IDbQueryable<T2> query2, IDbQueryable<T3> query3, IDbTransaction transaction = null);
        ...
        /// <param name="commandText">SQL 命令</param>
        /// <param name="transaction">事务</param>
        Task<Tuple<List<T1>, List<T2>, List<T3>, List<T4>, List<T5>, List<T6>, List<T7>>> ExecuteMultipleAsync<T1, T2, T3, T4, T5, T6, T7>(string commandText, IDbTransaction transaction = null);
