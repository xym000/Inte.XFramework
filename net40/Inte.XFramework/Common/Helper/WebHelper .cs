...
namespace Inte.XFramework
{
    ...
    public class WebHelper
    {
        ...
        public static T HttpPost<T>(string uri, string content, IDictionary<string, string> headers = null, string contentType = "application/json", int? timeout = null)
        {
            ...
            if (uri.StartsWith("https", StringComparison.OrdinalIgnoreCase)) ServicePointManager.SecurityProtocol = SecurityProtocolType.Ssl3;
            ...
            try
            {
                ...
                T value = SerializeHelper.DeserializeFromJson<T>(reader.ReadToEnd());
                return value;
            }
            finally
            {
